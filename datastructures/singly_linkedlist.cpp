...
/**
 * Singly Linked List consists of multiple nodes, connected to each other
...
int main() {
    /**
     * We generate an instance of singly linked list class and perform operations
     */ 
    cout << "\nThis program generates a sample singly linked list object.\n" << endl;
